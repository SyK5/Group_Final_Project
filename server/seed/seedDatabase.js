...
if (!process.env.DB_URI) {
  ...
  const sampleProducts = [
...

    {
      ...
      description:
        "The Royal Atlantis box spring bed offers luxurious comfort and premium design for your bedroom. Its high-quality craftsmanship ensures a perfect night's sleep. Featuring an elegant aesthetic and durable materials, it is a premium choice for modern bedroom decor.",
        price: "$5480.00",
        category: "Bedroom",
        image_name: [
  ...
  const seedProducts = async () => {
    try {
      ...
      const parsedProducts = sampleProducts.map((product) => ({
        ...product,
